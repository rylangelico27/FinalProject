                    ...
                    <table class="table table-hover fs-5">
                        <thead class="align-middle">
                            <tr class="table-danger">
                                <th class="tableHeadingProd" colspan="2">Product</th>
                        ...
                        <tbody class="table-group-divider align-middle">
                                ...
                                @foreach ($products as $product)
                                    @if ($product->id == $cart->product_id)
                                        ...
                                        <tr class="cartRow">
                                            ...
                                            <td>
                                                <form method="POST" action="{{ route('DeleteWishlist', $cart->id) }}">
                                                    @csrf
                                                    <button class="removeToWish btn btn-danger mx-2" type="submit">Remove from Wishlist</button>
                                                </form>
                                            </td>
                            ...
                            @if ($isThereRecords == 0)
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="text-center">No Items Found in Wishlist</td>
                                        </tr>
                                    </tbody>
                                </table>
                            @endif
