...
{{--
                                        ...
                                        <li class="navbarIcon nav-item">
                                            <a href="" class="dropdown-item text-light mx-2"><i class="bi bi-cart2"></i></a>
                                        </li>

                                        <div class="btn-group  mx-2">
                                            <a href="" type="button" class="text-light" data-bs-toggle="dropdown" aria-expanded="false">
 ...
 --}}
        ...
        <!--  CAROUSEL  -->
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" style="margin-top: 56px;">
        ...
        <div class="container my-5 m-auto" id="products">
            ...
            <div class="filterButt">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="background-color: #ff523b;">
                    <li><a href="{{ request()->routeIs('NewOld') ? '#' : route('NewOld') . '#productsList' }}" class="filterOption dropdown-item {{ request()->routeIs('NewOld') || request()->is('/') ? 'disabled' : '' }}">Newest to Oldest</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="container d-flex justify-content-end">
                                ...
                                {{--
                                    <a href="{{ auth()->check() ? '#' : route('login') }}">
                                    <i class="cartWishIcon mx-3 bi bi-cart-plus-fill"></i>
                                </a>
                                --}}
                                ...
                                {{--
                                    <a href="{{ auth()->check() ? '#' : route('login') }}">
                                    <i class="cartWishIcon bi bi-bag-plus-fill"></i>
                                </a>
                                --}}
                            </div>
                        </div>
